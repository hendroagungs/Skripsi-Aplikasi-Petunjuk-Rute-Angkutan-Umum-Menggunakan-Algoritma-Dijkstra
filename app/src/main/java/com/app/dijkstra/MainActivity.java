...
public class MainActivity extends FragmentActivity implements OnMapClickListener, OnMapLongClickListener,OnMapReadyCallback {
	...
	*/
		...
		spinner_list_smk.add("Choose a destination");
		...
		spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				if(arg0.getItemAtPosition(arg2).toString() != "Choose a destination"){
	 				...
	 				if(__global_yourCoordinate_exist != null){
	 					...
	 					Toast.makeText(getApplicationContext(), "Tap the map to choose a stating point", Toast.LENGTH_LONG).show();
	 				}
	...
	public void onMapClick(LatLng arg0) {
		...
		if(endposition != null){
			...
			Toast.makeText(getApplicationContext(), "Choose a destination", Toast.LENGTH_LONG).show();
		}
	...
	public void startingScript(double latUser, double lngUser, double lat_endposition, double lng_endposition) throws JSONException{				
		...
		if(algo.status == "die"){
			...
			Toast.makeText(getApplicationContext(), "No result. Please choose another starting point", Toast.LENGTH_LONG).show();
	...
	public void onMapReady(GoogleMap map) {
		googleMap=map;
		googleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(24.786545, 120.998491), 17.5f));//24.786476, 120.998247
		googleMap.setOnMapClickListener(this);
		googleMap.setOnMapLongClickListener(this);
	}
}
