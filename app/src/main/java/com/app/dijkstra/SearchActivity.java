...
import com.app.dijkstra.Tambah_simpul;
import com.app.dijkstra.SearchActivity;
...
public class SearchActivity extends FragmentActivity implements OnMapClickListener, OnMapLongClickListener,OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		/*final Button click = (Button)findViewById(R.id.camerabutton);
		...
		*/
        ...
        // BUAT MAP
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.peta);
	...
	*/
        ...
        spinner_list_smk.add("Pilih Tujuan");
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1,
                ...
                if(arg0.getItemAtPosition(arg2).toString() != "Pilih Tujuan"){

                    String pilih_smk = arg0.getItemAtPosition(arg2).toString();
                    cursor = db.rawQuery("SELECT koordinat FROM lokasi where lokasi = '" + pilih_smk + "'", null);
                    cursor.moveToFirst();
                    ...
                    if(__global_yourCoordinate_exist != null){
                        ...
                        Toast.makeText(getApplicationContext(), "Ketuk untuk memilih posisi awal", Toast.LENGTH_LONG).show();
                    }
    ...
    public void onMapClick(LatLng arg0) {
        ...
        if(endposition != null){
            ...
            Toast.makeText(getApplicationContext(), "Pilih Tujuan", Toast.LENGTH_LONG).show();
        }
    ...
    public void startingScript(double latUser, double lngUser, double lat_endposition, double lng_endposition) throws JSONException{
        ...
        if(algo.status == "die"){
            ...
            Toast.makeText(getApplicationContext(), "Error, Pilih lokasi awal lain", Toast.LENGTH_LONG).show();
    ...
    public void onMapReady(GoogleMap map) {
        googleMap=map;
        googleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-6.3015658, 107.29665249999994), 17.5f));//24.786476, 120.998247
        googleMap.setOnMapClickListener(this);
        googleMap.setOnMapLongClickListener(this);
    }
    public void onBackPressed() {
        intent = new Intent(SearchActivity.this, MenuUtama.class);
